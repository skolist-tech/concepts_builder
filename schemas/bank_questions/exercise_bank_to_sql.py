...
from schemas.bank_questions import ExerciseQuestionsBank
...
async def upload_exercise_bank_to_supabase(
    client: supabase.Client, 
    exercise_bank: ExerciseQuestionsBank, 
    subject_id: str
) -> dict:
    """
    Convert a ExerciseQuestionsBank object to dictionary records and upload to Supabase.
    ...
    if not exercise_bank:
        logger.warning("Exercise bank is empty.")
        return 0
    if not exercise_bank.exercise_questions:
        logger.warning("No questions found in the exercise bank.")
        return 0
    ...
    try:
        ...
        for q in exercise_bank.exercise_questions:
        ...
        return {
            "questions_total": len(exercise_bank.exercise_questions),
        ...
        logger.error(f"Error uploading exercise bank to Supabase: {e}")
