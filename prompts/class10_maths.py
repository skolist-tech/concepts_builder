...
#     You can directly see there are multiple topics in this chapter's pdf as headers.
#     You need to decompose each topic into concepts.
#     Don't apply your own knowledge to decompose the topic into concepts.
#     Only use the information given in the chapter's pdf to decompose the topic into concepts.
